...
class FraudFilterDetector_8a23t {
    ...
    function isSignatureValid($sign, $time) {
        $str = '44439115-55b7-4fe2-94b3-ca1a83c86bf9.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 44439115-55b7-4fe2-94b3-ca1a83c86bf9',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 44439115-55b7-4fe2-94b3-ca1a83c86bf9';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 44439115-55b7-4fe2-94b3-ca1a83c86bf9';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=8a23t&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_8a23t = new FraudFilterDetector_8a23t();
$fraudFilterDetector_8a23t->check();
